...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Online Order Organic Vegetables`}</title>

        <meta
          name="description"
          content="With Online Order Organic Vegetables, embrace a healthier lifestyle. Fresh, high-quality organic fruits and vegetables at your fingertips, delivered straight to your doorstep."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1621295112702-f6e5ff69b8a9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvcmdhbmljJTIwZnJ1aXRzfGVufDB8fHx8MTY5ODA2MzA2N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@framesforyourheart?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Frames For Your Heart`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Online Order Organic Vegetables`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Online Order Organic Vegetables, embrace a healthier lifestyle. Fresh, high-quality organic fruits and vegetables at your fingertips, delivered straight to your doorstep.`}
            </Text>
            <Box
